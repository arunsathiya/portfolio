...
[My address is hosted on ProtonMail with a custom domain](https://www.arun.blog/5-months-with-protonmail-and-i-havent-looked-back/). In my opinion, ProtonMail is the safest email can get, thanks to their built-in PGP encryption and [published security details](https://protonmail.com/security-details).
...
[HEY email](https://www.arun.blog/basecamp-hey-and-apple/) is Basecamp's bet in turning that around. They aim to offer a Gmail-like service that's easy to get started and manage, and respect users' privacy. Of course, it's a paid email service.
