...
<R2Image
	imageKey='assets/hydroxide-headless-bridge-for-protonmail-on-tailscale-1921638e-cd98-8071-a14b-f07941051964.png'
	alt='Proton staff comment after a headless bridge.'
/>
...
<R2Image
	imageKey='assets/hydroxide-headless-bridge-for-protonmail-on-tailscale-1921638e-cd98-8024-ba65-e3293f0af834.png'
	alt="tomoqv's GitHub comment about updating the ProtonMail authentication endpoint"
/>
...
<R2Image
	imageKey='assets/hydroxide-headless-bridge-for-protonmail-on-tailscale-1921638e-cd98-80c3-942c-d3645032408c.png'
	alt="dvalter's GitHub comment about using a SessionID cookie for ProtonMail bridge authentication"
/>

<R2Image
	imageKey='assets/hydroxide-headless-bridge-for-protonmail-on-tailscale-1921638e-cd98-8039-a88b-ee3d5bf83754.png'
	alt="dvalter's GitHub comment about using Session ID as an authentication parameter for Hydroxide"
/>
...
<R2Image
	imageKey='assets/hydroxide-headless-bridge-for-protonmail-on-tailscale-1921638e-cd98-80e1-87fe-e873131c5aac.png'
	alt='Replacing the local host and ports with Tailscale node address'
/>
...
<R2Image
	imageKey='assets/hydroxide-headless-bridge-for-protonmail-on-tailscale-1921638e-cd98-8052-a890-e1d4e3296bb7.png'
	alt='An image from my Tailscale admin that shows access control rules for my Hydroxide ports'
/>
