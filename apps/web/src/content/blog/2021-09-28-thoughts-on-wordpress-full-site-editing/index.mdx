...
<R2Image
	imageKey='assets/thoughts-on-wordpress-full-site-editing-53ae846c-1d75-424e-804c-2ea4301ed73a.png'
	alt='A screenshot of my WordPress site homepage'
/>
...
<R2Image
	imageKey='assets/thoughts-on-wordpress-full-site-editing-4a79b9de-cff0-41be-ba1d-7dd6fccdf17f.png'
	alt='A screenshot of my editor view on WordPress with Gutenberg'
/>

Likewise, here's a comparison of the single blog post view:

<R2Image
	imageKey='assets/thoughts-on-wordpress-full-site-editing-f180d5e9-7857-4305-af28-294e025d7254.png'
	alt='A screenshot of my WordPress site’s single blog post view'
/>

<R2Image
	imageKey='assets/thoughts-on-wordpress-full-site-editing-d2d99e7a-628f-46d9-a7bc-21c61db2a145.png'
	alt='A screenshot of editor view on my WordPress site'
/>
