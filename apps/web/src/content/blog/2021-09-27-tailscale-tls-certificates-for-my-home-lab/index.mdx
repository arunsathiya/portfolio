...
pubDate: 'Sep 27 2021 12:00 AM'
updatedDate: 'Feb 23 2025 3:24 PM'
tags: ["Tools","DevOps"]
...
Thanks to Docker, [I have been running a Whoogle instance](https://www.arun.blog/whoogle-on-the-tailscale-network/) and [a libreddit instance](https://www.arun.blog/libreddit-on-tailscale/) for a while. Each on a different port, while Tailscale and pihole are installed on the Raspberry Pi directly. It has worked well so far, but one thing that bugged me is the lack of HTTPS support.


That changed a while ago because Tailscale TLS certificates are now available for each node address: [Provision TLS certificates for your internal Tailscale services](https://tailscale.com/blog/tls-certs/). Obtaining the certificate and its key was very easy. Setting up my services ([pihole](https://www.arun.blog/private-pi-hole-hosting-fly-tailscale/), libreddit and Whoogle) to use the TLS certificate was a different challenge though.
...
<R2Image imageKey="assets/tailscale-tls-certificates-for-my-home-lab-5e11ac3a-ce18-4dbb-8ff9-05c0afe3f875.png" alt="Tailscale TLS certificates on a Whoogle instance" />
