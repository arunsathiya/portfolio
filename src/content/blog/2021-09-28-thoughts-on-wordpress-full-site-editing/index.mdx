...
pubDate: 'Sep 28 2021 12:00 AM'
updatedDate: 'Jul 06 2025 7:09 AM'
...
<R2Image imageKey="assets/thoughts-on-wordpress-full-site-editing-53ae846c-1d75-424e-804c-2ea4301ed73a.png" alt="A screenshot of my WordPress site homepage" />
...
<R2Image imageKey="assets/thoughts-on-wordpress-full-site-editing-4a79b9de-cff0-41be-ba1d-7dd6fccdf17f.png" alt="A screenshot of my editor view on WordPress with Gutenberg" />


Likewise, here's a comparison of the single blog post view:


<R2Image imageKey="assets/thoughts-on-wordpress-full-site-editing-f180d5e9-7857-4305-af28-294e025d7254.png" alt="A screenshot of my WordPress site’s single blog post view" />


<R2Image imageKey="assets/thoughts-on-wordpress-full-site-editing-d2d99e7a-628f-46d9-a7bc-21c61db2a145.png" alt="A screenshot of editor view on my WordPress site" />
...
Overall, like any software, WordPress Full Site Editing is not perfect. But the community and my colleagues at Automattic are hard at work. I imagine Full Site Editing to be the gold standard of website building experience in the coming years. If you wish to participate in the testing, the [instructions here can help](https://make.wordpress.org/test/handbook/full-site-editing-outreach-experiment/how-to-test-fse).
