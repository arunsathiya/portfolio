...
Replying to the email reveals your primary address to the sender. DuckDuckGo is not an alias service like [SimpleLogin or Anonaddy](https://blogarunsathiya.wordpress.com/2020/06/25/of-emails-and-aliases/).
...
<R2Image
	imageKey='blog/assets/duckduckgo-email-protection-first-impressions-10d1638e-cd98-80eb-9a61-ced2db6b354c.png'
	alt='An image illustrating how the DuckDuckGo Email Protection service works. It shows two mailboxes, one being the DuckDuckGo alias, and the other being the actual inbox where the email is forwarded to, with trackers removed.'
/>

At WWDC 2021, [Apple announced a client-wide email blocking functionality](https://blogarunsathiya.wordpress.com/2021/06/08/my-favorite-wwdc21-announcements/), but that's limited to the default Apple Mail client. I wanted something that works irrespective of what email client I use. pi-hole works in a way, because it blocks all DNS requests for these trackers, but I haven't done a detailed analysis of what kind of email trackers it actually blocks. Perhaps there a blocklist specifically tailored to email trackers.
...
<R2Image
	imageKey='blog/assets/duckduckgo-email-protection-first-impressions-10d1638e-cd98-80d8-9729-d6968c6aff7e.png'
	alt="Image showing an email with DuckDuckGo's notice about the number of email trackers removed, and it has a link to a privacy report."
/>

<R2Image
	imageKey='blog/assets/duckduckgo-email-protection-first-impressions-10d1638e-cd98-8050-89cb-ed443429e09f.png'
	alt="Image showing an email with DuckDuckGo's notice about the email not containing any trackers."
/>
...
<R2Image
	imageKey='blog/assets/duckduckgo-email-protection-first-impressions-10d1638e-cd98-8033-9590-fa1443bb7e9d.png'
	alt="Image showing DuckDuckGo Email Protection service's privacy report page for an email that I received. It shows details of the tracker removed and an option to turn off the throwaway DuckDuckGo alias."
/>
...
[video](https://youtu.be/VsypF-DBaow)
...
<R2Image
	imageKey='blog/assets/duckduckgo-email-protection-first-impressions-10d1638e-cd98-80ac-a031-c4a7ac127c93.png'
	alt="Image showing a setting on the SimpleLogin website's mailbox settings page, to add an authorized sender address"
/>
