...
I share my Tailscale network with friends and family, mostly to allow their usage of my [pi-hole nodes](https://www.arun.blog/private-pi-hole-hosting-fly-tailscale). I wanted to prevent them from using my exit nodes though.
...
<R2Image imageKey="assets/tailscale-exit-nodes-internet-access-1181638e-cd98-80a0-a9d0-ee3b36b88c1b.png" alt="A screenshot of a GitHub comment, which describes a new host to control internet access on the exit nodes using Tailscale Access Control Lists." />
