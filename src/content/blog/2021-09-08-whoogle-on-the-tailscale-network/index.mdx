...
I recently learned about Whoogle though and I had been wanting to try that for a while. It's a self-hosted, ad and tracker-free search engine that fetches results from Google. The project promises that it's free of cookie and IP address tracking too. It's open source and it seems that it can be set up on any device. I have two Raspberry Pi devices at home, both connected on my Tailscale network, [acting as ](https://www.arun.blog/post/pi-hole-on-tailscale/)[Pi-hole](https://www.arun.blog/pi-hole-on-tailscale/)[ nodes to block ads](https://www.arun.blog/post/pi-hole-on-tailscale/). One of the two Raspberry Pis [also acts as my Hydroxide node to fetch ProtonMail emails](https://www.arun.blog/post/hydroxide-headless-bridge-for-protonmail-on-tailscale/).
