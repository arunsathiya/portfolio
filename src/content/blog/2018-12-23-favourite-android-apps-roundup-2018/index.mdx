...
pubDate: 'Dec 23 2018 12:00 AM'
updatedDate: 'Feb 02 2025 4:41 PM'
tags: ["Tools"]
...
Keybase is probably my top choice today for sharing secure information. Unlike Telegram, it offers the flexibility of enjoying e2e encrypted communication between all the devices the user has. To be more clear, while e2e chats on Telegram are available only on the device the chat's launched from, with Keybase one can enjoy e2e chats on all devices, with realtime synchronisation.
...
I cannot miss [1Password](https://www.arun.blog/6-months-1password-trial/) and Bitwarden. Until 2018, I did not use password managers and when I joined Automattic, I realised password managers are an absolute need for any internet user.
...
Disclaimer first, [I work for Automattic](https://www.arun.blog/automattic/), the company behind Simplenote.
