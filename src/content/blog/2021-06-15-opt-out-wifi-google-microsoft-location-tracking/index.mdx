...
tags: ['Security']
generateImageTitle: 'Harden WiFi security'
---
...
**Related**: [Setting up pihole on the Tailscale network to block ads and telemetry on the go](https://blogarunsathiya.wordpress.com/2021/03/30/pi-hole-on-tailscale/).
