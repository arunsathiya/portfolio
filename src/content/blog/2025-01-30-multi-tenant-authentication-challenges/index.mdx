...
<R2Image imageKey="assets/multi-tenant-authentication-challenges-18b1638e-cd98-80a8-936c-c8f8bda288a2" alt="A screenshot of a frontend application on a Vercel deployment URL (which cannot be disabled) gated by Clerk login." />
