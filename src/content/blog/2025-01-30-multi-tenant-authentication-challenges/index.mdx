...
3. Vercel providing more control over deployment URL generationBut for now, this combination of Clerk's protection mechanisms offers a reasonable middle ground. The experience has taught me that sometimes in authentication architecture, we need to work creatively within the constraints of multiple services' limitations.
