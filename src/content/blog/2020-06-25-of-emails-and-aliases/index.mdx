...
<R2Image
	imageKey='blog/assets/of-emails-and-aliases-288c971f-439e-4348-8b5f-4e11157631e9.jpg'
	alt='A stock image showing an illustration of a conversation bubble'
/>

[My address is hosted on ProtonMail with a custom domain](https://blogarunsathiya.wordpress.com/2018/12/22/5-months-with-protonmail-and-i-havent-looked-back/). In my opinion, ProtonMail is the safest email can get, thanks to their built-in PGP encryption and [published security details](https://protonmail.com/security-details).
...
[HEY email](https://blogarunsathiya.wordpress.com/2020/06/18/basecamp-hey-and-apple/) is Basecamp's bet in turning that around. They aim to offer a Gmail-like service that's easy to get started and manage, and respect users' privacy. Of course, it's a paid email service.

[embed](https://twitter.com/dhh/status/1276157586434383874)
...
[embed](https://twitter.com/levelsio/status/1085785937601212417)
